...
在运行界面往右拨动摇杆可以进入UI设置模式，UI设置共有三个页面：算法设置、摄像头设置、硬件设置 
...
**设置区域**：设置区域可以进行参数的设置和查看，设置后会自动退出到菜单选项区域 

**操作说明**：当摇杆悬停到不同的控件上时，会显示相应的介绍信息或操作说明，相当于说明书的作用
